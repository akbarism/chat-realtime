...
<div class="btn-group dropleft">
          <i class="fas fa-ellipsis-v" title="Menu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></i>
  <div class="dropdown-menu">
    ...
    <button class="dropdown-item" type="button"><router-link to="login">Log Out</router-link></button>
  </div>
</div>
      </div>
      <div class="search">
      ...
      <div class="parent-chat" >
          <div class="child-chat" @click="$emit('sendslide')">
              <img src="../assets/img/dp.png" alt="">
              <div class="info-msg">
                  <div class="list-name">
                      <h6>Awikwok</h6>
                  </div>
                  <div class="msg"><p>samlekom hehhe mhamankx</p></div>
              </div>
