<template>
  <div class="container-fluid d-flex justify-content-center align-items-center">
      ...
      <div class="tagline d-flex justify-content-center align-items-center pb-3 pt-2 col-md-4 flex-column text-light">
          <h1 class="mt-5">Register</h1>
             <form class="sub-from col-md-11">
                  <div class="form-group p-0 m-1">
                    <label for="exampleInputEmail1">Fullname</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" v-model="fullname">
                </div>
                 <div class="form-group p-0 m-1">
                ...
                <p class="p-0 m-0">have have an account? <router-link to='login'>Login</router-link></p>
            </form>
      </div>
  </div>
</template>
...
.container-fluid{
    margin: 0;
    padding: 0;
    background:linear-gradient(150deg, #610bfc, #ff37cc);
    height: 100vh;
}
 .tagline{
     width: 30%;
 ...
 .btn{
    background:linear-gradient(69deg, #610bfc, #ff37cc);
    border: none;
 }
